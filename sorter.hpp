...
private:
  ...
  static constexpr size_t MEMORY_SIZE = 5;
...
public:
  TapeSorter(Tape * in, Tape * out, TempTapeCreator & creator):
    in_(in),
    out_(out),
    creator_(creator)
  {
  ...
  void sort()
  {
    ...
    tmp_[0] = creator_.create();
    tmp_[1] = creator_.create();
    tmp_[2] = creator_.create();
